...
export default function Modal() {
    ...
    return(
        <dialog open className="text-[var(--white)] fixed z-10 top-[10%] left-[10%] w-[75%] h-[80%] border-4 border-[var(--purple)] rounded-xl bg-[var(--gray)] flex flex-col items-center justify-around">
            ...
            <div className="flex justify-around items-center w-full mb-4">
                ...
                <table>
                    <tbody className="flex flex-col gap-2 items-center">
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <Image src={Hero2.imgs.md} alt={Hero2.name} width={175} height={175} />
                </div>
            </div>
